...
type BaseDesignTokens = {
  ...
  surfacePolicy: {
    ...
    shadow: "none" | "soft" | "glass" | "newmorphic";
    opacity: number;
  };
};
...
export const DESIGN_PRESETS: Record<DecorationStyleName, BaseDesignTokens> = {
  ...
  data: {
    ...
    cornerAccent: false,
    cards: true,
    surfacePolicy: { shapeSource: "svg", cornerScale: "fixed", shadow: "none", opacity: 0.96 },
  },
  magazine: {
    name: "magazine",
    decorationStyle: "magazine",
