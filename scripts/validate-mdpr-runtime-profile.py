...
GATES = [
    ...
    },
    {
        ...
        "commands": ["corepack pnpm --filter @mdpresent/core test", "corepack pnpm --filter @mdpresent/cli test", "corepack pnpm test:pack"],
        "testFiles": ["packages/core/test/core.test.mjs", "packages/cli/test/orchestrate.test.mjs", "scripts/pack-smoke.mjs"],
        "assertionTags": [
            "parseMarkdown preserves bridge paragraph marker edge fixture order",
            "validateDeck rejects renderer-owned asset and template fields in agent hints",
            "bridge-edge-allowed-hints.json",
            "bridge-edge-conflict-hints.json",
